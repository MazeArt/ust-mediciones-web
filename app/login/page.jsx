...
export default function Login() {
  ...
  return (
    ...
    >
      {/* Agregar pseudo-elemento para opacidad de imagen de fondo */}
      <div
      ...
      <div className=" z-10 mx-auto w-full  p-6 bg-white rounded-lg shadow-lg max-w-2xl ">
        <div>
          <h2 className=" text-left text-2xl font-extrabold text-gray-900">
            Ingresa a tu cuenta
          </h2>
        </div>
        {sessionDetected && ( // Render this message if sessionDetected is true
          <div className="text-center text-green-500 font-semibold">
            Sesion Activa Detectada, Ingresando...
          </div>
        )}
        ...
        <form className="mt-3 space-y-6" ref={formRef} onSubmit={signIn}>
          ...
          <div className="flex items-center justify-between gap-2 pt-2 ">
            ...
            <button
              type="submit"
              disabled={loading}
              className="group relative flex justify-center items-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-red-aiep hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
            >
              {loading && (
                <svg
