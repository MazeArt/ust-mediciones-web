...
function UnityApp() {
  const awsUrl = "https://ust-mediciones-sp2.s3.sa-east-1.amazonaws.com/Build_LabMinero/UST_BuildLabMineroQA";
  ...
  const {
    ...
    loaderUrl: awsUrl + `/Build/UST_BuildLabMineroQA.loader.js`,
    dataUrl: awsUrl + `/Build/UST_BuildLabMineroQA.data`,
    frameworkUrl: awsUrl + `/Build/UST_BuildLabMineroQA.framework.js`,
    codeUrl: awsUrl + `/Build/UST_BuildLabMineroQA.wasm`,
  });
